...
const API = axios.create({ baseURL: 'https://pcw-export.herokuapp.com/'})
...
export const fetchProductsByUser = (searchQuery) => API.get(`/products/product?searchQuery=${searchQuery.search}`);
